                    ...
                    <div className="col-md-8 login-form text-center">
                        ...
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className="form-group">
                                <input name="email" type="text" value={email} onChange={e => this.setState({email: e.target.value})} className="form-control" placeholder="Your Email..."/>
                            </div>
                            <div className="form-group">
                                <input type="text" className="form-control" value={private_key} placeholder="Your Private Key.. "  onChange={e => this.setState({private_key: e.target.value})} name="private_key"/>
                            </div>
                            <div className="form-group">
